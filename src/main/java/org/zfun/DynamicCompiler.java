...
public class DynamicCompiler {
    ...
    /* where the compiled class is saved to */
    private static String CLASS_OUTPUT_FOLDER = "/tmp/classes/demo";
    ...
    private static JavaFileObject getJavaFileObject() {
        StringBuilder contents = new StringBuilder("package math;" + "public class Calculator { "
                + "  public void testAdd() { " + "    System.out.println(100+200+300); " + "  } "
    ...
    public static void compile(Iterable<? extends JavaFileObject> files) {
        ...
        Iterable<String> options = Arrays.asList("-d", CLASS_OUTPUT_FOLDER);
    ...
    public static void runIt() {
        ...
        File file = new File(CLASS_OUTPUT_FOLDER);

        try {
            // Convert File to a URL
            URI uri = file.toURI();
            URL url = uri.toURL();  // file:/classes/demo
