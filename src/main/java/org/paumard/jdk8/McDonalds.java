...
public class McDonalds {
    ...
    public static void main(String... args) throws Exception {
        // processing a file line by line the stream and lambda way
        List<McDonald> mcdos = new ArrayList<>();
        try (Stream<String> lines = Files.lines(Paths.get("files", "mcdonalds.csv"))) {
            mcdos = lines.map(s -> {
                // -149.95038,61.13712,"McDonalds-Anchorage,AK","3828 W Dimond
                // Blvd, Anchorage,AK, (907) 248-0597"
                // -72.84817,41.27988,"McDonalds-Branford,CT","424 W Main St,
                // Branford,CT, (203) 488-9353"
        ...
        Map.Entry<String, Long> entry = mcdos.stream()
                .collect(Collectors.groupingBy(McDonald::city, Collectors.counting()))
                .entrySet()
                .stream()
