...
public class Movies {
    ...
    public static void main(String... args) throws Exception {
        ...
        try (Stream<String> lines = Files.lines(Paths.get("files", "movies-mpaa.txt"), 
        ...
        Map.Entry<Integer, Long> entry1 = movies.stream()
                .collect(Collectors.groupingBy(movie -> movie.actors().size(), 
                        Collectors.counting()))
                .entrySet()
                .stream()
        ...
        Map.Entry<Integer, Long> entry2 = movies.stream()
        ...
        Map.Entry<Actor, Long> entry3 = actors.stream().parallel()
        ...
        Map.Entry<Actor, Map.Entry<Integer, Long>> entry4 = actors.stream().parallel()
                .collect(Collectors.toMap(Function.identity(),
                                        actor -> movies.stream().
                                        filter(movie -> movie.actors().contains(actor))
